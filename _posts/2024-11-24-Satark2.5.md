...
![Cybersecurity solution usage stats](/assets/images/cyberStatsan.png)
## the GOOD part?
### nmaps and ip
...
![Output of ip a command](/assets/images/ipaSan.png)

and running `nmap` let's say on your college website will give you a result like: 
![Sample nmap scan output](/assets/images/nmapCollegeSitesan.png)
...
![Burp Suite intercept demo](/assets/images/burpsuitDemosan.png)
